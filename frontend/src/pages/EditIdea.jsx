  ...
  if (loading) {
    return (
      <div className="max-w-3xl mx-auto py-12">
        <div className="glass-card rounded-3xl p-8 border border-slate-800 animate-pulse space-y-4">
    ...
    return (
      <div className="max-w-md mx-auto py-16 text-center space-y-4">
        <div className="glass-card rounded-3xl p-8 border border-slate-800">
          ...
          <h2 className="text-xl font-bold text-white mt-2">Edit Error</h2>
          <p className="text-sm text-slate-400">{error || 'Idea not found'}</p>
          <Link
            to="/ideas"
            className="mt-4 inline-block px-4 py-2 bg-indigo-600 text-white font-bold rounded-xl text-sm hover:bg-indigo-700"
          >
      ...
      <div className="glass-card rounded-3xl p-6 sm:p-8 border border-slate-800 space-y-6 shadow-2xl">
        <div className="border-b border-slate-800 pb-4">
          <h1 className="text-2xl font-extrabold text-white flex items-center space-x-3">
            <div className="w-9 h-9 rounded-xl bg-amber-600/30 border border-amber-500/40 flex items-center justify-center text-amber-300">
